...
# instance fields
.field public final synthetic a:Lcom/honeyspace/data/db/FolderIconDB_Impl;


# direct methods
.method public constructor <init>(Lcom/honeyspace/data/db/FolderIconDB_Impl;)V
    .locals 2

    iput-object p1, p0, Ll6/i;->a:Lcom/honeyspace/data/db/FolderIconDB_Impl;

    const/4 p1, 0x1

    const-string v0, "c11c03805eda683f90880d3751f05336"

    const-string v1, "836523d8e5f8df89e8e4b716d6835910"
...
.method public final createAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `folder_icon` (`id` INTEGER NOT NULL, `icon` BLOB, PRIMARY KEY(`id`))"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'c11c03805eda683f90880d3751f05336\')"
...
.method public final dropAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    const-string p0, "DROP TABLE IF EXISTS `folder_icon`"
...
.method public final onOpen(Landroidx/sqlite/SQLiteConnection;)V
    ...
    sget v0, Lcom/honeyspace/data/db/FolderIconDB_Impl;->b:I

    iget-object p0, p0, Ll6/i;->a:Lcom/honeyspace/data/db/FolderIconDB_Impl;
...
.method public final onValidateSchema(Landroidx/sqlite/SQLiteConnection;)Landroidx/room/RoomOpenDelegate$ValidationResult;
    ...
    const-string v0, "folder_icon(com.honeyspace.sdk.database.entity.FolderIconData).\n Expected:\n"
