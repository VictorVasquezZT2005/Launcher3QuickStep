...
.method public final bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    :goto_1
    iget-object p0, p2, Lkf/t;->b:Ljava/lang/String;
...
.method public final createQuery()Ljava/lang/String;
    ...
    const-string p0, "INSERT OR REPLACE INTO `apps` (`packageName`,`userId`,`count`,`lastUpdate`,`id`) VALUES (?,?,?,?,nullif(?, 0))"

    return-object p0

    :pswitch_0
    const-string p0, "INSERT OR REPLACE INTO `tasklock` (`lock_id`,`affinity_name`) VALUES (?,?)"

    return-object p0

    :pswitch_1
    const-string p0, "INSERT OR REPLACE INTO `space` (`db_name`,`title`,`unique_key`,`package_name`) VALUES (?,?,?,?)"

    return-object p0

    :pswitch_2
    const-string p0, "INSERT OR ABORT INTO `inversion_grid_position` (`id`,`item_id`,`position_x`,`position_y`,`span_x`,`span_y`,`options`,`color`,`rank`,`alpha`,`scale`,`angle`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_3
    const-string p0, "INSERT OR ABORT INTO `multi_display_position` (`id`,`item_id`,`display_type`,`container_type`,`container_id`,`position_x`,`position_y`,`span_X`,`span_y`,`rank`) VALUES (?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_4
    const-string p0, "INSERT OR ABORT INTO `item_group` (`id`,`type`,`container_id`,`item_group_position`,`grid_x`,`grid_y`,`rank`,`display_type`,`background`,`arrangement`,`alpha`,`scale`,`angle`,`reference_package_name`,`extend_style`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_5
    const-string p0, "INSERT OR ABORT INTO `item` (`id`,`type`,`title`,`intent`,`component`,`app_widget_id`,`icon`,`icon_package`,`icon_resource`,`options`,`color`,`profile_id`,`restored`,`hidden`,`spanX`,`spanY`,`rank`,`item_position`,`position_x`,`position_y`,`container_type`,`container_id`,`alpha`,`scale`,`angle`,`reference_package_name`,`extend_style`,`homeup_extend_data`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_6
    const-string p0, "INSERT OR REPLACE INTO `landHome` (`component_name`,`item_type`,`is_preloaded_folder`,`folder_name`,`is_new_page_needed`,`is_replaceable`,`page_index`,`cell_x`,`cell_y`,`span_x`,`span_y`,`shortcut_title`,`shortcut_icon`,`result_state`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_7
    const-string p0, "INSERT OR REPLACE INTO `frontHome` (`component_name`,`item_type`,`is_preloaded_folder`,`folder_name`,`is_new_page_needed`,`is_replaceable`,`page_index`,`cell_x`,`cell_y`,`span_x`,`span_y`,`shortcut_title`,`shortcut_icon`,`result_state`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_8
    const-string p0, "INSERT OR REPLACE INTO `home` (`component_name`,`item_type`,`is_preloaded_folder`,`folder_name`,`is_new_page_needed`,`is_replaceable`,`page_index`,`cell_x`,`cell_y`,`span_x`,`span_y`,`shortcut_title`,`shortcut_icon`,`result_state`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_9
    const-string p0, "INSERT OR REPLACE INTO `apps` (`component_name`,`is_preloaded_folder`,`folder_name`,`page_index`,`result_state`) VALUES (?,?,?,?,?)"

    return-object p0

    :pswitch_a
    const-string p0, "INSERT OR REPLACE INTO `icon` (`component_name`,`profile_id`,`last_updated`,`version`,`icon`,`icon_color`,`label`,`system_state`,`theme`,`dark_mode`,`default_theme`) VALUES (?,?,?,?,?,?,?,?,?,?,?)"

    return-object p0

    :pswitch_b
    const-string p0, "INSERT OR REPLACE INTO `folder_icon` (`id`,`icon`) VALUES (?,?)"

    return-object p0

    :pswitch_c
    const-string p0, "INSERT OR REPLACE INTO `denylist` (`component_name`,`icon`,`label`) VALUES (?,?,?)"
