...
.method public constructor <init>(Ljava/io/File;)V
    ...
    const-string/jumbo v1, "unable to use a symbolic link: "
...
.method public static setPermissionsToOwnerOnlyWindows(Ljava/io/File;)V
    ...
    invoke-static {v8, v0, v10, v3, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-static {v9, v10}, Lk3/e0;->t(I[Ljava/lang/Object;)Lk3/e0;
    ...
    sget-object v5, Ljava/nio/file/attribute/AclEntryType;->ALLOW:Ljava/nio/file/attribute/AclEntryType;

    invoke-virtual {v4, v5}, Ljava/nio/file/attribute/AclEntry$Builder;->setType(Ljava/nio/file/attribute/AclEntryType;)Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v4

    invoke-virtual {v4, v1}, Ljava/nio/file/attribute/AclEntry$Builder;->setPrincipal(Ljava/nio/file/attribute/UserPrincipal;)Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v1

    invoke-virtual {v1, v3}, Ljava/nio/file/attribute/AclEntry$Builder;->setPermissions(Ljava/util/Set;)Ljava/nio/file/attribute/AclEntry$Builder;
    ...
    invoke-static {v1, v0, v2}, Lar/d;->h(IILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v2, v1}, Lk3/z;->s(I[Ljava/lang/Object;)Lk3/u0;

    move-result-object v0

    invoke-interface {p0, v0}, Ljava/nio/file/attribute/AclFileAttributeView;->setAcl(Ljava/util/List;)V
