...
.field private final tracer:Lkr/q;
...
.method public constructor <init>(Lcom/google/api/client/http/HttpTransport;Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/google/api/client/http/OpenCensusUtils;->getTracer()Lkr/q;

    move-result-object v0

    iput-object v0, p0, Lcom/google/api/client/http/HttpRequest;->tracer:Lkr/q;
...
.method private static addSpanAttribute(Lkr/i;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
...
.method public execute()Lcom/google/api/client/http/HttpResponse;
    ...
    iget-object v5, v1, Lcom/google/api/client/http/HttpRequest;->tracer:Lkr/q;

    sget-object v6, Lcom/google/api/client/http/OpenCensusUtils;->SPAN_NAME_HTTP_REQUEST_EXECUTE:Ljava/lang/String;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v5, Lhr/c;->d:Lhr/c;

    sget-object v7, Lhr/a;->a:Lhr/b;

    check-cast v7, Lhr/g;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v7, Lhr/g;->b:Ljava/lang/ThreadLocal;
    ...
    :goto_1
    sget-object v7, Lnr/a;->a:Lcom/google/gson/internal/e;

    const-string v8, "context"

    invoke-static {v5, v8}, Lns/f0;->O(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v5, Lhr/c;->a:La2/h;
    ...
    invoke-interface {v5, v9, v4, v7}, Lhr/f;->b(IILjava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v5, Lkr/d;->e:Lkr/d;

    :cond_6
    const-string v5, "name"

    invoke-static {v6, v5}, Lns/f0;->O(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v7, v9}, Lns/f0;->O(Ljava/lang/Object;Ljava/lang/String;)V

    sget-object v7, Lkr/i;->c:Ljava/util/Map;
    ...
    invoke-static {v5, v7, v9}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lkr/i;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v9, v7}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lkr/i;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v7, v0}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lkr/i;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v11}, Landroidx/collection/a;->v(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v14, v3}, Lcom/google/api/client/http/HttpRequest;->addSpanAttribute(Lkr/i;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v13, v3}, La6/r;->u(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v3}, Lcom/google/api/client/http/OpenCensusUtils;->propagateTracingContext(Lkr/i;Lcom/google/api/client/http/HttpHeaders;)V
    ...
    iget-object v0, v1, Lcom/google/api/client/http/HttpRequest;->tracer:Lkr/q;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Lkr/e;

    invoke-direct {v3, v5}, Lkr/e;-><init>(Lkr/i;)V

    invoke-virtual {v7}, Lcom/google/api/client/http/LowLevelHttpRequest;->getContentLength()J

    move-result-wide v10

    invoke-static {v5, v10, v11}, Lcom/google/api/client/http/OpenCensusUtils;->recordSentMessageEvent(Lkr/i;J)V
    ...
    invoke-static {v5, v6, v7}, Lcom/google/api/client/http/OpenCensusUtils;->recordReceivedMessageEvent(Lkr/i;J)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v3}, Lkr/e;->close()V
    ...
    :cond_21
    invoke-static/range {v16 .. v16}, Lcom/google/api/client/http/OpenCensusUtils;->getEndSpanOptions(Ljava/lang/Integer;)Lkr/f;

    move-result-object v1

    move-object/from16 v4, v22

    invoke-static {v1, v4}, Lns/f0;->O(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :goto_1a
    invoke-static {v8}, Lcom/google/api/client/http/OpenCensusUtils;->getEndSpanOptions(Ljava/lang/Integer;)Lkr/f;

    move-result-object v2

    invoke-static {v2, v4}, Lns/f0;->O(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public executeAsync()Ljava/util/concurrent/Future;
    ...
    invoke-direct {v2, v1, v0}, Lo3/s;-><init>(Ljava/util/concurrent/ThreadFactory;Ljava/lang/Boolean;)V
