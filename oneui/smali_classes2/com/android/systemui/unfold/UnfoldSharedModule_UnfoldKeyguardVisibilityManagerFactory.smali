...
.method private constructor <init>(Lcom/android/systemui/unfold/UnfoldSharedModule;Ldagger/internal/Provider;)V
    ...
    iput-object p2, p0, Lcom/android/systemui/unfold/UnfoldSharedModule_UnfoldKeyguardVisibilityManagerFactory;->implProvider:Ldagger/internal/Provider;

    return-void
.end method

.method public static create(Lcom/android/systemui/unfold/UnfoldSharedModule;Ldagger/internal/Provider;)Lcom/android/systemui/unfold/UnfoldSharedModule_UnfoldKeyguardVisibilityManagerFactory;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/systemui/unfold/UnfoldSharedModule_UnfoldKeyguardVisibilityManagerFactory;-><init>(Lcom/android/systemui/unfold/UnfoldSharedModule;Ldagger/internal/Provider;)V
...
.method public get()Lcom/android/systemui/unfold/util/UnfoldKeyguardVisibilityManager;
    ...
    iget-object p0, p0, Lcom/android/systemui/unfold/UnfoldSharedModule_UnfoldKeyguardVisibilityManagerFactory;->implProvider:Ldagger/internal/Provider;
