...
.field private static final TAG:Ljava/lang/String; = "FloatingRotationButton"
...
.field private mSamsungBottomMarginResource:I

.field private mSamsungDiameterResource:I

.field private mSamsungHiddenVisualCueRotateBtnResource:I
...
.method private adjustViewPositionAndCreateLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {v2}, Lcom/android/systemui/shared/rotation/RotationUtil$Companion;->getFloatingButtonPosition()I
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->updateTranslation(Lcom/android/systemui/shared/rotation/FloatingRotationButtonPositionCalculator$Position;Z)V
...
.method private updateDimensionResources()V
    ...
    invoke-virtual {v4, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButtonView;->setDiameter(I)V
...
.method public onDestroy()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->setRotationButtonController(Lcom/android/systemui/shared/rotation/RotationButtonController;)V

    invoke-virtual {p0, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p0, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->setOnHoverListener(Landroid/view/View$OnHoverListener;)V

    invoke-virtual {p0, v0}, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->setUpdatesCallback(Lcom/android/systemui/shared/rotation/RotationButton$RotationButtonUpdatesCallback;)V
...
.method public setDependencies(III)V
    .locals 0

    iput p1, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mSamsungBottomMarginResource:I

    iput p2, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mSamsungDiameterResource:I

    iput p3, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mSamsungHiddenVisualCueRotateBtnResource:I
...
.method public show()Z
    ...
    new-instance v2, Lcom/android/systemui/shared/rotation/a;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lcom/android/systemui/shared/rotation/a;-><init>(Lcom/android/systemui/shared/rotation/FloatingRotationButton;I)V
...
.method public updateIcon(II)V
    ...
    const-string/jumbo v1, "updateIcon() drawable="
    ...
    :try_start_0
    invoke-virtual {v2}, Lcom/android/systemui/shared/rotation/RotationButtonController;->getContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mRotationButtonController:Lcom/android/systemui/shared/rotation/RotationButtonController;

    invoke-virtual {v3}, Lcom/android/systemui/shared/rotation/RotationButtonController;->getIconResId()I
    ...
    iput-object v2, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mAnimatedDrawable:Landroid/graphics/drawable/AnimatedVectorDrawable;
    ...
    iget-object v2, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    iget v3, p0, Lcom/android/systemui/shared/rotation/FloatingRotationButton;->mSamsungHiddenVisualCueRotateBtnResource:I
    ...
    const-string/jumbo v3, "updateIcon() Exception "
