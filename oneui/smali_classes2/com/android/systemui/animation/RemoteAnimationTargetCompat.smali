...
.method public static synthetic a(Lcom/android/wm/shell/shared/h;Landroid/window/TransitionInfo$Change;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/android/systemui/animation/RemoteAnimationTargetCompat;->lambda$wrapApps$0(Lcom/android/wm/shell/shared/h;Landroid/window/TransitionInfo$Change;)Z
...
.method private static synthetic lambda$wrapApps$0(Lcom/android/wm/shell/shared/h;Landroid/window/TransitionInfo$Change;)Z
    .locals 1
...
.method private static synthetic lambda$wrapNonApps$1(ZLandroid/window/TransitionInfo$Change;)Z
    ...
    invoke-static {p1}, Lcom/android/wm/shell/shared/i;->f(Landroid/window/TransitionInfo$Change;)Z
...
.method private static wrap(Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/util/ArrayMap;Ljava/util/function/Predicate;)[Landroid/view/RemoteAnimationTarget;
    ...
    invoke-static {v2}, Lcom/android/wm/shell/shared/i;->e(Landroid/window/TransitionInfo$Change;)Z
    ...
    invoke-static {v2, v3, p0, p1, p2}, Lcom/android/wm/shell/shared/i;->i(Landroid/window/TransitionInfo$Change;ILandroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/util/ArrayMap;)Landroid/view/RemoteAnimationTarget;
...
.method public static wrapApps(Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/util/ArrayMap;)[Landroid/view/RemoteAnimationTarget;
    ...
    invoke-direct {v0, p0}, Lcom/android/wm/shell/shared/h;-><init>(Landroid/window/TransitionInfo;)V

    new-instance v1, Lcom/android/systemui/animation/v;

    invoke-direct {v1, v0}, Lcom/android/systemui/animation/v;-><init>(Lcom/android/wm/shell/shared/h;)V
...
.method public static wrapNonApps(Landroid/window/TransitionInfo;ZLandroid/view/SurfaceControl$Transaction;Landroid/util/ArrayMap;)[Landroid/view/RemoteAnimationTarget;
    ...
    new-instance v0, Lcom/android/systemui/animation/u;

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Lcom/android/systemui/animation/u;-><init>(ZI)V
