...
.method private getDataListFromPackageManager(I)Ljava/util/List;
    ...
    invoke-static {v3}, Landroidx/reflect/os/SeslUserHandleReflector;->semGetIdentifier(Ljava/lang/Object;)I

    move-result v3

    iget-object v5, p0, Landroidx/picker/features/scs/AppDataListBixbyFactory;->mContext:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v5

    invoke-static {v5, v1, v4, v3}, Landroidx/reflect/app/SeslApplicationPackageManagerReflector;->semQueryIntentActivitiesAsUser(Ljava/lang/Object;Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v7, p1}, Landroidx/picker/features/scs/AppDataListBixbyFactory;->createAppInfoData(ILandroid/content/pm/ResolveInfo;I)Landroidx/picker/model/AppInfoData;
    ...
    const-string v2, "Failed to get data using semGetIdentifier and semQueryIntentActivitiesAsUser"
...
.method private getDataListFromSCS(I)Ljava/util/List;
    ...
    invoke-virtual {v0}, Landroidx/picker/features/scs/AppDataListBixbyFactory;->getAuthority()Ljava/lang/String;
