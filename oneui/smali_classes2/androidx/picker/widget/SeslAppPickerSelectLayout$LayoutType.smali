...
.field public static final enum PORT_HEADER:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

.field public static final enum PORT_HEADER_SELECTED:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
...
.method private static synthetic $values()[Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
    ...
    sget-object v5, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

    sget-object v6, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER_SELECTED:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

    filled-new-array/range {v0 .. v6}, [Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
...
.method static constructor <clinit>()V
    ...
    sget v2, Landroidx/picker/R$layout;->picker_app_list_select_layout_header_portrait:I

    const-string v3, "PORT_HEADER"

    invoke-direct {v0, v3, v1, v2}, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

    new-instance v0, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

    const/4 v1, 0x6

    sget v2, Landroidx/picker/R$layout;->picker_app_list_select_layout_header_portrait_with_selected:I

    const-string v3, "PORT_HEADER_SELECTED"

    invoke-direct {v0, v3, v1, v2}, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER_SELECTED:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
...
.method public static getPortHeaderLayoutType(Z)Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
    .locals 0

    if-eqz p0, :cond_0

    sget-object p0, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER_SELECTED:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;

    return-object p0

    :cond_0
    sget-object p0, Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;->PORT_HEADER:Landroidx/picker/widget/SeslAppPickerSelectLayout$LayoutType;
