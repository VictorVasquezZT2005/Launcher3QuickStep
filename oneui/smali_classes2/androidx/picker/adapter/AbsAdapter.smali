...
.method private convertCategoryViewData2AppInfoViewData(Landroidx/picker/model/viewdata/CategoryViewData;)Landroidx/picker/model/viewdata/AppInfoViewData;
    ...
    new-instance v0, Landroidx/picker/adapter/AbsAdapter$2;

    invoke-direct {v0, p0, v2, v2}, Landroidx/picker/adapter/AbsAdapter$2;-><init>(Landroidx/picker/adapter/AbsAdapter;Landroidx/picker/model/AppInfoData;Landroidx/picker/model/AppInfoDataImpl;)V

    new-instance p0, Landroidx/picker/adapter/a;

    invoke-direct {p0, p1}, Landroidx/picker/adapter/a;-><init>(Landroidx/picker/model/viewdata/CategoryViewData;)V

    invoke-direct {v3, v0, p0}, Landroidx/picker/loader/AppIconFlow;-><init>(Landroidx/picker/features/observable/UpdateMutableState;Lkotlinx/coroutines/flow/Flow;)V
...
.method public static synthetic f(Landroidx/picker/model/viewdata/CategoryViewData;Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic h(Landroidx/picker/model/viewdata/AppSideViewData;)Landroidx/picker/model/AppData;
    .locals 0
...
.method private isFilterMatch(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    :cond_2
    invoke-static {p0, p1}, Landroidx/picker/features/search/InitialSearchUtils;->getMatchedStringOffset(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {p2, p1}, Landroidx/picker/features/search/InitialSearchUtils;->getMatchedStringOffset(Ljava/lang/String;Ljava/lang/String;)I
...
.method public generateFilterHeader(Ljava/lang/String;Ljava/util/List;)Landroidx/picker/model/viewdata/ViewData;
    ...
    new-instance p0, La7/c2;

    const/16 v0, 0xf

    invoke-direct {p0, v0}, La7/c2;-><init>(I)V

    invoke-static {p2, p0}, Lkotlin/collections/CollectionsKt;->q(Ljava/util/Collection;Lkotlin/jvm/functions/Function1;)Ljava/util/List;
