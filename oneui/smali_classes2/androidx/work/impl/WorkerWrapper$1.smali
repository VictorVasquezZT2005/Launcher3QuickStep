...
.field final synthetic val$runExpedited:Lo3/q;


# direct methods
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper;Lo3/q;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/WorkerWrapper$1;->val$runExpedited:Lo3/q;
...
.method public run()V
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/WorkerWrapper$1;->val$runExpedited:Lo3/q;
    ...
    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->startWork()Lo3/q;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroidx/work/impl/utils/futures/SettableFuture;->setFuture(Lo3/q;)Z
    :try_end_0
