...
.method private final addEntryToBackStack(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavBackStackEntry;Ljava/util/List;)V
    ...
    instance-of v0, v8, Landroidx/navigation/FloatingWindow;
    ...
    invoke-virtual {v0}, Landroidx/navigation/NavController;->getBackQueue()Lkotlin/collections/ArrayDeque;
...
.method private final navigate(Landroidx/navigation/NavDestination;Landroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    invoke-virtual {v0, v2}, Landroidx/navigation/NavController;->unlinkChildFromParent$navigation_runtime_release(Landroidx/navigation/NavBackStackEntry;)Landroidx/navigation/NavBackStackEntry;

    .line 75
    new-instance v2, Landroidx/navigation/NavBackStackEntry;

    invoke-direct {v2, v1, v12}, Landroidx/navigation/NavBackStackEntry;-><init>(Landroidx/navigation/NavBackStackEntry;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v2, v1}, Landroidx/navigation/NavController;->linkChildToParent(Landroidx/navigation/NavBackStackEntry;Landroidx/navigation/NavBackStackEntry;)V

    .line 79
    :cond_3
    invoke-virtual {v5, v2}, Landroidx/navigation/Navigator;->onLaunchSingleTop(Landroidx/navigation/NavBackStackEntry;)V
    ...
    invoke-direct {v5, v6, v0, v11, v12}, Landroidx/navigation/NavController$navigate$4;-><init>(Lkotlin/jvm/internal/Ref$BooleanRef;Landroidx/navigation/NavController;Landroidx/navigation/NavDestination;Landroid/os/Bundle;)V
...
.method private final popBackStackInternal(IZZ)Z
    ...
    invoke-direct/range {v5 .. v10}, Landroidx/navigation/NavController$popBackStackInternal$2;-><init>(Lkotlin/jvm/internal/Ref$BooleanRef;Lkotlin/jvm/internal/Ref$BooleanRef;Landroidx/navigation/NavController;ZLkotlin/collections/ArrayDeque;)V

    invoke-direct {v8, v0, v1, v9, v5}, Landroidx/navigation/NavController;->popBackStackInternal(Landroidx/navigation/Navigator;Landroidx/navigation/NavBackStackEntry;ZLkotlin/jvm/functions/Function1;)V
    ...
    .line 26
    sget-object p0, Landroidx/navigation/NavController$popBackStackInternal$3;->INSTANCE:Landroidx/navigation/NavController$popBackStackInternal$3;

    invoke-static {v3, p0}, Lkotlin/sequences/SequencesKt;->generateSequence(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)Lkotlin/sequences/Sequence;

    move-result-object p0

    .line 27
    new-instance p1, Landroidx/navigation/NavController$popBackStackInternal$4;

    invoke-direct {p1, v8}, Landroidx/navigation/NavController$popBackStackInternal$4;-><init>(Landroidx/navigation/NavController;)V
    ...
    .line 29
    iget-object p2, v8, Landroidx/navigation/NavController;->backStackMap:Ljava/util/Map;
    ...
    invoke-virtual {v8, p1}, Landroidx/navigation/NavController;->findDestination(I)Landroidx/navigation/NavDestination;

    move-result-object p1

    .line 33
    sget-object p2, Landroidx/navigation/NavController$popBackStackInternal$6;->INSTANCE:Landroidx/navigation/NavController$popBackStackInternal$6;
    ...
    .line 34
    new-instance p2, Landroidx/navigation/NavController$popBackStackInternal$7;

    invoke-direct {p2, v8}, Landroidx/navigation/NavController$popBackStackInternal$7;-><init>(Landroidx/navigation/NavController;)V
    ...
    .line 36
    iget-object p3, v8, Landroidx/navigation/NavController;->backStackMap:Ljava/util/Map;
    ...
    .line 37
    :cond_a
    iget-object p1, v8, Landroidx/navigation/NavController;->backStackStates:Ljava/util/Map;
    ...
    .line 38
    :cond_b
    invoke-direct {v8}, Landroidx/navigation/NavController;->updateOnBackPressedCallbackEnabled()V
...
.method private final restoreStateInternal(ILandroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)Z
    ...
    new-instance v0, Landroidx/navigation/NavController$restoreStateInternal$4;
...
.method public getViewModelStoreOwner(I)Landroidx/lifecycle/ViewModelStoreOwner;
    ...
    invoke-static {p1, p0, v0}, La6/r;->h(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public handleDeepLink(Landroid/content/Intent;)Z
    ...
    iget-object v0, v0, Landroidx/navigation/NavController;->activity:Landroid/app/Activity;
    ...
    invoke-static {v11, v1, v3}, La6/r;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v0, v0, Landroidx/navigation/NavController;->context:Landroid/content/Context;

    invoke-virtual {v2, v0, v4}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroid/content/Context;I)Ljava/lang/String;
...
.method public navigate(ILandroid/os/Bundle;Landroidx/navigation/NavOptions;Landroidx/navigation/Navigator$Extras;)V
    ...
    .line 26
    invoke-static {v1, p3, v2}, La6/r;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public saveState()Landroid/os/Bundle;
    ...
    invoke-static {v4, v5}, La6/r;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public setGraph(Landroidx/navigation/NavGraph;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, p2, v0}, Landroidx/collection/SparseArrayCompat;->replace(ILjava/lang/Object;)Ljava/lang/Object;

    .line 15
    invoke-virtual {v3}, Landroidx/navigation/NavController;->getBackQueue()Lkotlin/collections/ArrayDeque;
    ...
    invoke-virtual {v2, v0}, Landroidx/navigation/NavBackStackEntry;->setDestination(Landroidx/navigation/NavDestination;)V
