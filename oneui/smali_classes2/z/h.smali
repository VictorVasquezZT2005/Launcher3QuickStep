...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lz/h;->B:Landroid/graphics/Matrix;
...
# virtual methods
.method public final b(Landroid/graphics/RectF;Lz/a;)Landroid/graphics/RectF;
    .locals 4

    iget-object v0, p0, Lz/h;->e:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Lz/h;->e:Landroid/graphics/RectF;

    :cond_0
    iget-object v0, p0, Lz/h;->g:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Lz/h;->g:Landroid/graphics/RectF;
    ...
    iget-object p2, p0, Lz/h;->g:Landroid/graphics/RectF;

    invoke-virtual {p2, p1}, Landroid/graphics/RectF;->set(Landroid/graphics/RectF;)V

    iget-object p1, p0, Lz/h;->e:Landroid/graphics/RectF;

    iget-object p2, p0, Lz/h;->g:Landroid/graphics/RectF;

    invoke-virtual {p1, p2}, Landroid/graphics/RectF;->union(Landroid/graphics/RectF;)V

    iget-object p0, p0, Lz/h;->e:Landroid/graphics/RectF;
...
.method public final c()V
    ...
    iget-object v1, v0, Lz/h;->a:Landroid/graphics/Canvas;

    if-eqz v1, :cond_1e

    iget-object v1, v0, Lz/h;->b:Lfm/d1;

    if-eqz v1, :cond_1e

    iget-object v1, v0, Lz/h;->q:[F

    if-eqz v1, :cond_1e

    iget-object v1, v0, Lz/h;->d:Landroid/graphics/RectF;
    ...
    :cond_0
    iget-object v1, v0, Lz/h;->y:Landroid/graphics/RenderNode;
    ...
    iget-object v3, v0, Lz/h;->b:Lfm/d1;

    iget-object v3, v3, Lfm/d1;->c:Ljava/lang/Object;

    check-cast v3, Lz/a;

    iget-object v4, v0, Lz/h;->y:Landroid/graphics/RenderNode;

    if-eqz v4, :cond_5

    iget-object v4, v0, Lz/h;->z:Landroid/graphics/RenderNode;

    if-eqz v4, :cond_5

    iget-object v4, v0, Lz/h;->q:[F
    ...
    :cond_2
    iget-object v4, v0, Lz/h;->A:Lz/a;

    if-eqz v4, :cond_3

    iget v7, v3, Lz/a;->a:F

    iget v11, v4, Lz/a;->a:F
    ...
    :cond_4
    iget-object v5, v0, Lz/h;->z:Landroid/graphics/RenderNode;

    invoke-virtual {v5, v4}, Landroid/graphics/RenderNode;->setRenderEffect(Landroid/graphics/RenderEffect;)Z

    iput-object v3, v0, Lz/h;->A:Lz/a;

    :goto_1
    iget-object v4, v0, Lz/h;->d:Landroid/graphics/RectF;

    invoke-virtual {v0, v4, v3}, Lz/h;->b(Landroid/graphics/RectF;Lz/a;)Landroid/graphics/RectF;
    ...
    iget-object v3, v0, Lz/h;->y:Landroid/graphics/RenderNode;

    invoke-virtual {v4, v3}, Landroid/graphics/Canvas;->drawRenderNode(Landroid/graphics/RenderNode;)V

    iget-object v3, v0, Lz/h;->z:Landroid/graphics/RenderNode;
    ...
    :cond_8
    iget-object v1, v0, Lz/h;->l:Landroid/graphics/Bitmap;
    ...
    iget-object v4, v0, Lz/h;->b:Lfm/d1;

    iget-object v4, v4, Lfm/d1;->c:Ljava/lang/Object;

    check-cast v4, Lz/a;

    iget-object v10, v0, Lz/h;->d:Landroid/graphics/RectF;

    if-eqz v10, :cond_18

    iget-object v11, v0, Lz/h;->l:Landroid/graphics/Bitmap;

    if-eqz v11, :cond_18

    invoke-virtual {v0, v10, v4}, Lz/h;->b(Landroid/graphics/RectF;Lz/a;)Landroid/graphics/RectF;

    move-result-object v10

    iget-object v11, v0, Lz/h;->f:Landroid/graphics/Rect;
    ...
    iput-object v11, v0, Lz/h;->f:Landroid/graphics/Rect;
    ...
    :cond_b
    iget-object v5, v0, Lz/h;->h:Landroid/graphics/RectF;
    ...
    iput-object v5, v0, Lz/h;->h:Landroid/graphics/RectF;
    ...
    iget-object v5, v0, Lz/h;->i:Landroid/graphics/Rect;
    ...
    iput-object v5, v0, Lz/h;->i:Landroid/graphics/Rect;

    :cond_d
    iget-object v5, v0, Lz/h;->i:Landroid/graphics/Rect;

    iget-object v11, v0, Lz/h;->h:Landroid/graphics/RectF;
    ...
    iget-object v12, v0, Lz/h;->h:Landroid/graphics/RectF;
    ...
    iget-object v5, v0, Lz/h;->r:Landroid/graphics/Bitmap;

    iget-object v11, v0, Lz/h;->h:Landroid/graphics/RectF;

    invoke-static {v5, v11}, Lz/h;->d(Landroid/graphics/Bitmap;Landroid/graphics/RectF;)Z
    ...
    :cond_e
    iget-object v5, v0, Lz/h;->s:Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v11}, Lz/h;->a(Landroid/graphics/RectF;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object v5

    iput-object v5, v0, Lz/h;->r:Landroid/graphics/Bitmap;
    ...
    iput-object v5, v0, Lz/h;->s:Landroid/graphics/Bitmap;

    new-instance v5, Landroid/graphics/Canvas;

    iget-object v11, v0, Lz/h;->r:Landroid/graphics/Bitmap;

    invoke-direct {v5, v11}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object v5, v0, Lz/h;->t:Landroid/graphics/Canvas;

    new-instance v5, Landroid/graphics/Canvas;

    iget-object v11, v0, Lz/h;->s:Landroid/graphics/Bitmap;

    invoke-direct {v5, v11}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object v5, v0, Lz/h;->u:Landroid/graphics/Canvas;

    goto :goto_4

    :cond_10
    iget-object v5, v0, Lz/h;->t:Landroid/graphics/Canvas;

    if-eqz v5, :cond_17

    iget-object v11, v0, Lz/h;->u:Landroid/graphics/Canvas;

    if-eqz v11, :cond_17

    iget-object v11, v0, Lz/h;->o:Lo/a;

    if-eqz v11, :cond_17

    iget-object v12, v0, Lz/h;->i:Landroid/graphics/Rect;

    invoke-virtual {v5, v12, v11}, Landroid/graphics/Canvas;->drawRect(Landroid/graphics/Rect;Landroid/graphics/Paint;)V

    iget-object v5, v0, Lz/h;->u:Landroid/graphics/Canvas;

    iget-object v11, v0, Lz/h;->i:Landroid/graphics/Rect;

    iget-object v12, v0, Lz/h;->o:Lo/a;
    ...
    iput-object v5, v0, Lz/h;->v:Lo/a;

    :cond_11
    iget-object v5, v0, Lz/h;->d:Landroid/graphics/RectF;
    ...
    iget-object v10, v0, Lz/h;->u:Landroid/graphics/Canvas;

    iget-object v12, v0, Lz/h;->l:Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lz/h;->w:Landroid/graphics/BlurMaskFilter;

    if-eqz v5, :cond_12

    iget v5, v0, Lz/h;->x:F

    iget v10, v4, Lz/a;->a:F
    ...
    iput-object v5, v0, Lz/h;->w:Landroid/graphics/BlurMaskFilter;

    goto :goto_5

    :cond_13
    iput-object v2, v0, Lz/h;->w:Landroid/graphics/BlurMaskFilter;
    ...
    iget-object v10, v0, Lz/h;->w:Landroid/graphics/BlurMaskFilter;
    ...
    iget-object v3, v0, Lz/h;->t:Landroid/graphics/Canvas;

    iget-object v5, v0, Lz/h;->s:Landroid/graphics/Bitmap;

    iget v10, v4, Lz/a;->b:F
    ...
    iget-object v8, v0, Lz/h;->v:Lo/a;

    invoke-virtual {v3, v5, v6, v4, v8}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    iget-object v3, v0, Lz/h;->r:Landroid/graphics/Bitmap;

    iget-object v4, v0, Lz/h;->i:Landroid/graphics/Rect;

    iget-object v5, v0, Lz/h;->f:Landroid/graphics/Rect;

    iget-object v6, v0, Lz/h;->k:Lo/a;
    ...
    :cond_19
    :goto_7
    iget-object v1, v0, Lz/h;->n:Landroid/graphics/Rect;
    ...
    iput-object v1, v0, Lz/h;->n:Landroid/graphics/Rect;

    :cond_1a
    iget-object v1, v0, Lz/h;->n:Landroid/graphics/Rect;

    iget-object v3, v0, Lz/h;->d:Landroid/graphics/RectF;
    ...
    iget-object v3, v0, Lz/h;->l:Landroid/graphics/Bitmap;

    iget-object v4, v0, Lz/h;->n:Landroid/graphics/Rect;
    ...
    :goto_8
    iput-object v2, v0, Lz/h;->a:Landroid/graphics/Canvas;
...
.method public final e(Landroid/graphics/Canvas;Landroid/graphics/RectF;Lfm/d1;)Landroid/graphics/Canvas;
    .locals 10

    iget-object v0, p0, Lz/h;->a:Landroid/graphics/Canvas;

    if-nez v0, :cond_15

    iget-object v0, p0, Lz/h;->q:[F
    ...
    iput-object v0, p0, Lz/h;->q:[F

    :cond_0
    iget-object v0, p0, Lz/h;->p:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lz/h;->p:Landroid/graphics/Matrix;
    ...
    iget-object v3, p0, Lz/h;->j:Landroid/graphics/RectF;
    ...
    iput-object v3, p0, Lz/h;->j:Landroid/graphics/RectF;
    ...
    iput-object p1, p0, Lz/h;->a:Landroid/graphics/Canvas;

    iput-object p3, p0, Lz/h;->b:Lfm/d1;

    iget v3, p3, Lfm/d1;->b:I
    ...
    iget-object v2, p0, Lz/h;->d:Landroid/graphics/RectF;
    ...
    iput-object v2, p0, Lz/h;->d:Landroid/graphics/RectF;
    ...
    sget-object p1, Lz/h;->B:Landroid/graphics/Matrix;

    if-eq v2, v6, :cond_e

    if-ne v2, v5, :cond_d

    iget-object v2, p0, Lz/h;->y:Landroid/graphics/RenderNode;
    ...
    iput-object v2, p0, Lz/h;->y:Landroid/graphics/RenderNode;
    ...
    iget-object v2, p0, Lz/h;->z:Landroid/graphics/RenderNode;
    ...
    iput-object v2, p0, Lz/h;->z:Landroid/graphics/RenderNode;

    iput-object v3, p0, Lz/h;->A:Lz/a;
    ...
    :cond_c
    :goto_2
    iget-object p3, p0, Lz/h;->y:Landroid/graphics/RenderNode;

    invoke-virtual {p3, v7}, Landroid/graphics/RenderNode;->setHasOverlappingRendering(Z)Z

    iget-object p3, p0, Lz/h;->y:Landroid/graphics/RenderNode;

    iget-object v2, p0, Lz/h;->j:Landroid/graphics/RectF;
    ...
    iget-object p0, p0, Lz/h;->j:Landroid/graphics/RectF;
    ...
    :cond_f
    iget-object v2, p0, Lz/h;->l:Landroid/graphics/Bitmap;

    iget-object v4, p0, Lz/h;->j:Landroid/graphics/RectF;

    invoke-static {v2, v4}, Lz/h;->d(Landroid/graphics/Bitmap;Landroid/graphics/RectF;)Z

    move-result v2

    if-eqz v2, :cond_11

    iget-object p1, p0, Lz/h;->l:Landroid/graphics/Bitmap;
    ...
    :cond_10
    iget-object p1, p0, Lz/h;->j:Landroid/graphics/RectF;

    sget-object v2, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-static {p1, v2}, Lz/h;->a(Landroid/graphics/RectF;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, p0, Lz/h;->l:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lz/h;->m:Landroid/graphics/Canvas;

    goto :goto_3

    :cond_11
    iget-object v2, p0, Lz/h;->m:Landroid/graphics/Canvas;

    if-eqz v2, :cond_12

    invoke-virtual {v2, p1}, Landroid/graphics/Canvas;->setMatrix(Landroid/graphics/Matrix;)V

    iget-object v4, p0, Lz/h;->m:Landroid/graphics/Canvas;
    ...
    iget-object p0, p0, Lz/h;->m:Landroid/graphics/Canvas;
