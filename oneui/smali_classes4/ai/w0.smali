...
.method public constructor <init>(IILjava/lang/String;IIIIILandroid/os/UserHandle;ILcom/honeyspace/sdk/source/entity/SpannableStyle;Lcom/honeyspace/sdk/database/field/ItemType;Lcom/honeyspace/sdk/source/entity/LabelEditableItem;Landroidx/lifecycle/MutableLiveData;)V
    ...
    .line 2
    iput p1, p0, Lai/w0;->p:I

    .line 3
    iput p2, p0, Lai/w0;->q:I

    .line 4
    iput-object p3, p0, Lai/w0;->r:Ljava/lang/String;

    .line 5
    iput p4, p0, Lai/w0;->s:I

    .line 6
    iput p5, p0, Lai/w0;->t:I

    .line 7
    iput p6, p0, Lai/w0;->u:I

    .line 8
    iput p7, p0, Lai/w0;->v:I

    .line 9
    iput p8, p0, Lai/w0;->w:I

    .line 10
    iput-object p9, p0, Lai/w0;->x:Landroid/os/UserHandle;

    .line 11
    iput p10, p0, Lai/w0;->y:I

    .line 12
    iput-object p11, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;

    .line 13
    iput-object p12, p0, Lai/w0;->A:Lcom/honeyspace/sdk/database/field/ItemType;

    .line 14
    iput-object p13, p0, Lai/w0;->B:Lcom/honeyspace/sdk/source/entity/LabelEditableItem;

    .line 15
    iput-object p14, p0, Lai/w0;->C:Landroidx/lifecycle/MutableLiveData;
    ...
    iput-object p1, p0, Lai/w0;->D:Ljava/lang/String;

    .line 22
    iput-object p0, p0, Lai/w0;->E:Lai/w0;

    return-void
.end method

.method public synthetic constructor <init>(ILjava/lang/String;IIIIILandroid/os/UserHandle;ILcom/honeyspace/sdk/source/entity/LabelEditableItem;I)V
    .locals 17
    ...
    .line 28
    invoke-direct/range {v2 .. v16}, Lai/w0;-><init>(IILjava/lang/String;IIIIILandroid/os/UserHandle;ILcom/honeyspace/sdk/source/entity/SpannableStyle;Lcom/honeyspace/sdk/database/field/ItemType;Lcom/honeyspace/sdk/source/entity/LabelEditableItem;Landroidx/lifecycle/MutableLiveData;)V

    return-void
.end method

.method public static x(Lai/w0;III)Lai/w0;
    .locals 15

    iget v1, p0, Lai/w0;->p:I

    iget v2, p0, Lai/w0;->q:I

    iget-object v3, p0, Lai/w0;->r:Ljava/lang/String;

    and-int/lit8 v0, p3, 0x8

    if-eqz v0, :cond_0

    iget v0, p0, Lai/w0;->s:I
    ...
    :goto_1
    iget v6, p0, Lai/w0;->u:I

    iget v7, p0, Lai/w0;->v:I

    iget v8, p0, Lai/w0;->w:I

    iget-object v9, p0, Lai/w0;->x:Landroid/os/UserHandle;

    iget v10, p0, Lai/w0;->y:I

    iget-object v11, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;

    iget-object v12, p0, Lai/w0;->A:Lcom/honeyspace/sdk/database/field/ItemType;

    iget-object v13, p0, Lai/w0;->B:Lcom/honeyspace/sdk/source/entity/LabelEditableItem;

    iget-object v14, p0, Lai/w0;->C:Landroidx/lifecycle/MutableLiveData;
    ...
    invoke-direct/range {v0 .. v14}, Lai/w0;-><init>(IILjava/lang/String;IIIIILandroid/os/UserHandle;ILcom/honeyspace/sdk/source/entity/SpannableStyle;Lcom/honeyspace/sdk/database/field/ItemType;Lcom/honeyspace/sdk/source/entity/LabelEditableItem;Landroidx/lifecycle/MutableLiveData;)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 4
    iget p1, p1, Lai/w0;->p:I

    .line 5
    iget p0, p0, Lai/w0;->p:I
...
.method public final getComponent()Ljava/lang/String;
    ...
    iget-object p0, p0, Lai/w0;->r:Ljava/lang/String;
...
.method public final getItem()Lcom/honeyspace/sdk/source/entity/BaseItem;
    ...
    iget-object p0, p0, Lai/w0;->E:Lai/w0;
...
.method public final getLabel()Landroidx/lifecycle/MutableLiveData;
    ...
    .line 1
    iget-object p0, p0, Lai/w0;->C:Landroidx/lifecycle/MutableLiveData;
...
.method public final getLabel()Ljava/lang/String;
    ...
    .line 2
    iget-object p0, p0, Lai/w0;->D:Ljava/lang/String;
...
.method public final getLabelEditableItem()Lcom/honeyspace/sdk/source/entity/LabelEditableItem;
    ...
    iget-object p0, p0, Lai/w0;->B:Lcom/honeyspace/sdk/source/entity/LabelEditableItem;
...
.method public final getSpannableStyle()Lcom/honeyspace/sdk/source/entity/SpannableStyle;
    ...
    iget-object p0, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;
...
.method public final getType()Lcom/honeyspace/sdk/database/field/ItemType;
    ...
    iget-object p0, p0, Lai/w0;->A:Lcom/honeyspace/sdk/database/field/ItemType;
...
.method public final getUser()Landroid/os/UserHandle;
    ...
    iget-object p0, p0, Lai/w0;->x:Landroid/os/UserHandle;
...
.method public final getWidgetSpanX()I
    ...
    invoke-virtual {p0}, Lai/w0;->getSpanX()I
...
.method public final getWidgetSpanY()I
    ...
    invoke-virtual {p0}, Lai/w0;->getSpanY()I
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Lai/w0;->r:Ljava/lang/String;

    invoke-static {v0, v1, v2}, Landroidx/compose/ui/input/pointer/a;->b(IILjava/lang/String;)I

    move-result v0

    iget v2, p0, Lai/w0;->s:I

    invoke-static {v2, v0, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget v2, p0, Lai/w0;->t:I

    invoke-static {v2, v0, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget v2, p0, Lai/w0;->u:I

    invoke-static {v2, v0, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget v2, p0, Lai/w0;->v:I

    invoke-static {v2, v0, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget v2, p0, Lai/w0;->w:I

    invoke-static {v2, v0, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget-object v2, p0, Lai/w0;->x:Landroid/os/UserHandle;
    ...
    iget v0, p0, Lai/w0;->y:I

    invoke-static {v0, v2, v1}, Lcom/samsung/android/rubin/sdk/module/fence/a;->d(III)I

    move-result v0

    iget-object v2, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;
    ...
    iget-object v0, p0, Lai/w0;->A:Lcom/honeyspace/sdk/database/field/ItemType;
    ...
    iget-object v2, p0, Lai/w0;->B:Lcom/honeyspace/sdk/source/entity/LabelEditableItem;
...
.method public final setLabel(Landroidx/lifecycle/MutableLiveData;)V
    ...
    .line 1
    iput-object p1, p0, Lai/w0;->C:Landroidx/lifecycle/MutableLiveData;
...
.method public final setSpannableStyle(Lcom/honeyspace/sdk/source/entity/SpannableStyle;)V
    ...
    iput-object p1, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;
...
.method public final toString()Ljava/lang/String;
    ...
    iget v0, p0, Lai/w0;->u:I

    iget-object v1, p0, Lai/w0;->z:Lcom/honeyspace/sdk/source/entity/SpannableStyle;

    iget-object v2, p0, Lai/w0;->C:Landroidx/lifecycle/MutableLiveData;

    const-string v3, ", appWidgetId="

    const-string v4, ", component="

    const-string v5, "CustomWidget(id="

    iget v6, p0, Lai/w0;->p:I

    iget v7, p0, Lai/w0;->q:I
    ...
    iget-object v6, p0, Lai/w0;->r:Ljava/lang/String;

    iget v7, p0, Lai/w0;->s:I
    ...
    iget v5, p0, Lai/w0;->v:I

    iget v6, p0, Lai/w0;->w:I
    ...
    iget-object v0, p0, Lai/w0;->x:Landroid/os/UserHandle;
...
.method public final v(I)Lcom/honeyspace/sdk/database/entity/ItemData;
    ...
    invoke-virtual {v0}, Lai/w0;->getSpanX()I

    move-result v15

    invoke-virtual {v0}, Lai/w0;->getSpanY()I

    move-result v16

    sget-object v1, Lcom/honeyspace/sdk/UserHandleWrapper;->INSTANCE:Lcom/honeyspace/sdk/UserHandleWrapper;

    iget-object v3, v0, Lai/w0;->x:Landroid/os/UserHandle;
    ...
    iget-object v0, v0, Lai/w0;->r:Ljava/lang/String;
