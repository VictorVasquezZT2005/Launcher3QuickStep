.class public Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/RecentSceneDrawingBag;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/RecentSceneDrawingBag;",
...
.method public static synthetic a(Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;)F
    ...
    invoke-static {p0}, Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/RecentSceneDrawingBag;->getShrinkCornerRadius$lambda$0(Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;)F
...
.method private static final getShrinkCornerRadius$lambda$0(Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;)F
    .locals 0
...
.method public getProgressRange(Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;)Lkotlin/Pair;
    ...
    invoke-virtual {p1}, Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;->getSceneFullyScale()Landroid/graphics/PointF;
...
.method public getShrinkSceneBound(Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p1}, Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;->getWindowInsets()Landroid/graphics/RectF;

    move-result-object v0

    invoke-static {p0, v0}, Lcom/honeyspace/common/taskscene/TaskSceneExtensionKt;->inset(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p1}, Lcom/honeyspace/ui/common/taskScene/scenedrawingbag/SceneLayoutData;->getSceneScale()Landroid/graphics/PointF;

    move-result-object p1

    invoke-static {p3, p1}, Lcom/honeyspace/common/taskscene/TaskSceneExtensionKt;->scaling(Landroid/graphics/RectF;Landroid/graphics/PointF;)Landroid/graphics/RectF;

    move-result-object p1

    invoke-static {p1, v0, p0}, Lcom/honeyspace/common/taskscene/TaskSceneExtensionKt;->scale(Landroid/graphics/RectF;FF)Landroid/graphics/RectF;

    move-result-object p0

    invoke-static {p2, p0}, Lcom/honeyspace/common/taskscene/TaskSceneExtensionKt;->inset(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
