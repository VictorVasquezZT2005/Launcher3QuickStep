...
.method public isFeatureSupported(Ljava/lang/String;)Z
    ...
    const-string v1, "JOIN_SPEC_AND_QUALIFIED_ID"
    ...
    :sswitch_0
    const-string v0, "SET_SCHEMA_REQUEST_SET_PUBLICLY_VISIBLE"
    ...
    :sswitch_1
    const-string v0, "SEARCH_SPEC_ADD_FILTER_PROPERTIES"
    ...
    :sswitch_5
    const-string v0, "SEARCH_SPEC_PROPERTY_WEIGHTS"
    ...
    :sswitch_8
    const-string v0, "GLOBAL_SEARCH_SESSION_GET_BY_ID"
    ...
    :sswitch_b
    const-string v0, "SEARCH_RESULT_MATCH_INFO_SUBMATCH"
    ...
    :sswitch_c
    const-string v0, "SEARCH_RESULT_PARENT_TYPES"
    ...
    :sswitch_d
    const-string v0, "SEARCH_SPEC_ADD_INFORMATIONAL_RANKING_EXPRESSIONS"
    ...
    :sswitch_e
    const-string v0, "SCHEMA_ADD_INDEXABLE_NESTED_PROPERTIES"
    ...
    :sswitch_f
    const-string v0, "SET_SCHEMA_REQUEST_ADD_SCHEMA_TYPE_VISIBLE_TO_CONFIG"
    ...
    :sswitch_11
    const-string v0, "TOKENIZER_TYPE_RFC822"
    ...
    :sswitch_12
    const-string v0, "GLOBAL_SEARCH_SESSION_REGISTER_OBSERVER_CALLBACK"
    ...
    :sswitch_13
    const-string v0, "SET_SCHEMA_CIRCULAR_REFERENCES"
    ...
    :sswitch_15
    const-string v0, "SEARCH_SPEC_GROUPING_TYPE_PER_SCHEMA"
    ...
    :sswitch_16
    const-string v0, "ADD_PERMISSIONS_AND_GET_VISIBILITY"
    ...
    :sswitch_17
    const-string v0, "SEARCH_SPEC_ADVANCED_RANKING_EXPRESSION"
    ...
    :sswitch_18
    const-string v0, "SCHEMA_EMBEDDING_PROPERTY_CONFIG"
    ...
    :sswitch_19
    const-string v0, "SCHEMA_ADD_PARENT_TYPE"
    ...
    :sswitch_1a
    const-string v0, "ENTERPRISE_GLOBAL_SEARCH_SESSION"
    ...
    :sswitch_1b
    const-string v0, "SEARCH_SPEC_SET_SEARCH_SOURCE_LOG_TAG"
    ...
    :sswitch_1c
    const-string v0, "GLOBAL_SEARCH_SESSION_GET_SCHEMA"
    ...
    :sswitch_1d
    const-string v0, "SEARCH_AND_CLICK_ACCUMULATOR"
    ...
    :pswitch_5
    invoke-virtual {p0, v1}, Landroidx/appsearch/platformstorage/FeaturesImpl;->isFeatureSupported(Ljava/lang/String;)Z
