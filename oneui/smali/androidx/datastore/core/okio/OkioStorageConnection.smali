...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onClose",
        "<init>",
        "(Lht/o;Lht/z;Landroidx/datastore/core/okio/OkioSerializer;Landroidx/datastore/core/InterProcessCoordinator;Lkotlin/jvm/functions/Function0;)V",
        "checkNotClosed",
        "()V",
        "R",
        "Lkotlin/Function3;",
...
.field private final path:Lht/z;
...
# direct methods
.method public constructor <init>(Lht/o;Lht/z;Landroidx/datastore/core/okio/OkioSerializer;Landroidx/datastore/core/InterProcessCoordinator;Lkotlin/jvm/functions/Function0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    iput-object p2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lht/z;
...
.method public readScope(Lkotlin/jvm/functions/Function3;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    iget-object v6, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lht/z;
    ...
    invoke-direct {v2, v5, v6, v7}, Landroidx/datastore/core/okio/OkioReadScope;-><init>(Lht/o;Lht/z;Landroidx/datastore/core/okio/OkioSerializer;)V
    :try_end_1
...
.method public writeScope(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v4, v0, Landroidx/datastore/core/okio/OkioStorageConnection$writeScope$1;->L$0:Ljava/lang/Object;

    check-cast v4, Landroidx/datastore/core/okio/OkioStorageConnection;
    ...
    iget-object p2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lht/z;

    invoke-virtual {p2}, Lht/z;->c()Lht/z;

    move-result-object p2

    if-eqz p2, :cond_b

    iget-object v2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;
    ...
    invoke-virtual {v2, v8}, Lht/o;->d(Lht/z;)Z

    move-result v9

    if-nez v9, :cond_4

    invoke-virtual {v7, v8}, Lkotlin/collections/ArrayDeque;->addFirst(Ljava/lang/Object;)V

    invoke-virtual {v8}, Lht/z;->c()Lht/z;
    ...
    invoke-virtual {v2, v8}, Lht/o;->b(Lht/z;)V
    ...
    invoke-virtual {v6}, Lht/z;->b()Ljava/lang/String;
    ...
    invoke-virtual {p1, v4}, Lht/z;->d(Ljava/lang/String;)Lht/z;
    ...
    :try_start_2
    iget-object v4, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    invoke-virtual {v4, p1}, Lht/o;->c(Lht/z;)V

    new-instance v4, Landroidx/datastore/core/okio/OkioWriteScope;

    iget-object v6, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    iget-object v7, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->serializer:Landroidx/datastore/core/okio/OkioSerializer;

    invoke-direct {v4, v6, p1, v7}, Landroidx/datastore/core/okio/OkioWriteScope;-><init>(Lht/o;Lht/z;Landroidx/datastore/core/okio/OkioSerializer;)V
    :try_end_2
    ...
    :try_start_6
    iget-object p0, v0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    invoke-virtual {p0, p1}, Lht/o;->d(Lht/z;)Z
    ...
    iget-object p2, v0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lht/z;

    invoke-virtual {p0, p1, p2}, Lht/o;->a(Lht/z;Lht/z;)V
    :try_end_6
    ...
    :goto_a
    :try_start_b
    iget-object v1, v0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;

    invoke-virtual {v1, p1}, Lht/o;->d(Lht/z;)Z
    ...
    :try_start_c
    iget-object v0, v0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lht/o;
    ...
    invoke-virtual {v0, p1}, Lht/o;->c(Lht/z;)V
    :try_end_c
