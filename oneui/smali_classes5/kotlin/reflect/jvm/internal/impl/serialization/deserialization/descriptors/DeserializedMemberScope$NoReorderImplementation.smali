...
.method static constructor <clinit>()V
    ...
    const-string v1, "declaredFunctions"

    const-string v2, "getDeclaredFunctions()Ljava/util/List;"
    ...
    const-string v1, "declaredProperties"

    const-string v2, "getDeclaredProperties()Ljava/util/List;"

    invoke-static {v0, v1, v2, v3}, Lar/d;->q(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;I)Lkotlin/reflect/KProperty1;

    move-result-object v5

    const-string v1, "allTypeAliases"

    const-string v2, "getAllTypeAliases()Ljava/util/List;"
    ...
    const-string v2, "getAllFunctions()Ljava/util/List;"
    ...
    const-string v2, "getAllProperties()Ljava/util/List;"

    invoke-static {v0, v1, v2, v3}, Lar/d;->q(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;I)Lkotlin/reflect/KProperty1;

    move-result-object v8

    const-string v1, "typeAliasesByName"

    const-string v2, "getTypeAliasesByName()Ljava/util/Map;"

    invoke-static {v0, v1, v2, v3}, Lar/d;->q(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;I)Lkotlin/reflect/KProperty1;

    move-result-object v9

    const-string v1, "functionsByName"

    const-string v2, "getFunctionsByName()Ljava/util/Map;"

    invoke-static {v0, v1, v2, v3}, Lar/d;->q(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;I)Lkotlin/reflect/KProperty1;

    move-result-object v10

    const-string v1, "propertiesByName"

    const-string v2, "getPropertiesByName()Ljava/util/Map;"
    ...
    const-string v1, "variableNames"

    const-string v2, "getVariableNames()Ljava/util/Set;"

    invoke-static {v0, v1, v2, v3}, Lar/d;->q(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;I)Lkotlin/reflect/KProperty1;

    move-result-object v13

    filled-new-array/range {v4 .. v13}, [Lkotlin/reflect/KProperty;
