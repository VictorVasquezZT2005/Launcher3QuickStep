...
# instance fields
.field public final synthetic a:Lcom/samsung/app/honeyspace/edge/fromrecent/database/MostUsedAppsDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/samsung/app/honeyspace/edge/fromrecent/database/MostUsedAppsDatabase_Impl;)V
    .locals 2

    iput-object p1, p0, Lto/e;->a:Lcom/samsung/app/honeyspace/edge/fromrecent/database/MostUsedAppsDatabase_Impl;

    const/4 p1, 0x1

    const-string v0, "137d8d169a591e01e0c1dbcec416e2b5"

    const-string v1, "c70b8244f87038e2228c4085e781dd00"
...
.method public final createAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `apps` (`packageName` TEXT NOT NULL, `userId` INTEGER NOT NULL, `count` INTEGER NOT NULL, `lastUpdate` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'137d8d169a591e01e0c1dbcec416e2b5\')"
...
.method public final onOpen(Landroidx/sqlite/SQLiteConnection;)V
    ...
    sget v0, Lcom/samsung/app/honeyspace/edge/fromrecent/database/MostUsedAppsDatabase_Impl;->b:I

    iget-object p0, p0, Lto/e;->a:Lcom/samsung/app/honeyspace/edge/fromrecent/database/MostUsedAppsDatabase_Impl;
...
.method public final onValidateSchema(Landroidx/sqlite/SQLiteConnection;)Landroidx/room/RoomOpenDelegate$ValidationResult;
    ...
    invoke-static {p0, v0, v5, v1}, Landroidx/compose/ui/input/pointer/a;->r(Ljava/util/HashMap;Ljava/lang/String;Landroidx/room/util/TableInfo$Column;I)Ljava/util/HashSet;
    ...
    const-string v0, "apps(com.samsung.app.honeyspace.edge.fromrecent.database.AppsEntity).\n Expected:\n"
