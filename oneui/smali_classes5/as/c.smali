...
.method static constructor <clinit>()V
    ...
    sput-object v0, Las/c;->m:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Las/c;->c:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v1, p0, Las/c;->k:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v2, p0, Las/c;->h:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Las/c;->g:I
    ...
    iput v3, p0, Las/c;->e:I

    iput-object v2, p0, Las/c;->j:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Las/c;->i:I

    add-int/lit8 p1, p1, -0x2

    int-to-long v1, p1

    iput-wide v1, p0, Las/c;->f:J
...
.method public final clear()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Las/c;->poll()Ljava/lang/Object;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Las/c;->isEmpty()Z
...
.method public final isEmpty()Z
    ...
    iget-object v0, p0, Las/c;->c:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v0

    iget-object p0, p0, Las/c;->k:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public final offer(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Las/c;->h:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Las/c;->c:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget v5, p0, Las/c;->g:I

    and-int/2addr v4, v5

    iget-wide v6, p0, Las/c;->f:J
    ...
    iput-object v13, p0, Las/c;->h:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    add-long/2addr v2, v5

    sub-long/2addr v2, v7

    iput-wide v2, p0, Las/c;->f:J
    ...
    sget-object p0, Las/c;->m:Ljava/lang/Object;
...
.method public final poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Las/c;->j:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Las/c;->k:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v7, Las/c;->m:Ljava/lang/Object;
    ...
    iput-object v6, p0, Las/c;->j:Ljava/util/concurrent/atomic/AtomicReferenceArray;
